...
function e_pasteupload(){
    Swal.fire({
        html: '<p class="text">Get Request<br>https://paste.agalts.xyz/upload?paste=Hello<br><br>Response<br>{"code":"hvft","error":false,"url":"https://paste.agalts.xyz/hvft"}<br><br><br>Post Request<br>https://paste.agalts.xyz/upload<br><br>Json Content<br>{"paste":"Hello World"}<br><br>Response<br>{"code":"hvft","error":false,"url":"https://paste.agalts.xyz/hvft"}</p>',
        icon: "info",
        width: "700",
    })
}
